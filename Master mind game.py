...
while again == "yes":
    ...
    #Generating Randomlist for the player
    import random
    randomlist = []
    ...
    print()
    print("Please leave a space between two digits")
    print()
    print(" Attempt No                    Guess                        Result")
    print("_______________________________________________________________________________")
    print()
    #Disignation of result
    player_list = []
    attempts = 1
    outcome_1 = ""
    outcome_2 = ""
    ...
    #Number of attempts for the player
    ...
    while (attempts < 9):
        ...
        print("---------------------------------------------------------> ",outcome_1,outcome_3)
        print("                                                           ",outcome_2,outcome_4)
